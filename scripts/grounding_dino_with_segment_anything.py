...
def main():
    parser = argparse.ArgumentParser(description="Grounding DINO + Segment Anything")
    parser.add_argument('--image_url', type=str, default="http://images.cocodataset.org/val2017/000000039769.jpg", help='Input image URL or path')
    parser.add_argument('--labels', type=str, nargs='+', default=["a cat.", "a remote control."], help='Detection labels')
