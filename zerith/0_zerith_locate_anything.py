...
class LocateAnythingWorker:
    ...
    _category_configs = [
        ...
        {
            "label": "a white clutch fluid reservoir with a white cap, a waisted cylindrical body (slightly narrower in the middle), and a full circumferential mounting clamp wrapping the side. A screw may be visible on this clamp",
            "mesh_file": "assets/category_2_1.obj",
            "enabled": True,
            "area_range": (0.020, 0.050),
            "color": "green"
        },
        {
            "label": "a white plastic fluid reservoir with a black cap, a straight cylindrical body with uniform width from top to bottom, and two circular mounting ears extending symmetrically outward on each side, with a bottom tube",
            "mesh_file": "assets/category_3.obj",
            "enabled": True,
            "area_range": (0.018, 0.040),
            "color": "blue"
        }, 
        {
            "label": "a yellow silicone component with a tapered shape (narrower at the top and wider at the bottom), featuring multiple layers of annular folds on the surface", 
            "mesh_file": "assets/category_4.obj",
            "enabled": True,
            "area_range": (0.023,0.045),
            "color": "yellow"
        }
    ]
